...
- [x] **Step 1: Add a multi-path snapshot fixture and test the dialog opening**
...
- [x] **Step 2: Extend the test to select the second path and confirm**
...
- [x] **Step 3: Add cancellation and single-path coverage**
...
- [x] **Step 1: Extend the dictionary contract**
...
- [x] **Step 2: Provide matching English and Simplified Chinese values**
...
- [x] **Step 3: Run the focused tests for dictionary/type feedback**
...
- Modify: `desktop-client/src/styles.css:659-740`

- [x] **Step 1: Add state for the pending group and selected row**
...
- [x] **Step 2: Branch group opening by path count**
...
- [x] **Step 3: Render a narrow dialog for multi-path groups**
...
- [x] **Step 1: Run the complete desktop validation gates**
