...
> 状态：已实现并验收（2026-04-28）；ExecPlan 已归档
...
| 助手 | 环境变量 |
|------|---------|
| Claude Code | `SKILLDRIVE_CLAUDE_CODE_SKILLS_PATH` |
| Codex | `SKILLDRIVE_CODEX_SKILLS_PATH` |
| Gemini CLI | `SKILLDRIVE_GEMINI_CLI_SKILLS_PATH` |
| Cursor | `SKILLDRIVE_CURSOR_SKILLS_PATH` |
| Windsurf | `SKILLDRIVE_WINDSURF_SKILLS_PATH` |
| Copilot | `SKILLDRIVE_COPILOT_SKILLS_PATH` |
| RooCode | `SKILLDRIVE_ROOCODE_SKILLS_PATH` |
| Cline | `SKILLDRIVE_CLINE_SKILLS_PATH` |
| OpenCode | `SKILLDRIVE_OPENCODE_SKILLS_PATH` |
| KiloCode | `SKILLDRIVE_KILOCODE_SKILLS_PATH` |
| Amp | `SKILLDRIVE_AMP_SKILLS_PATH` |
| Kiro | `SKILLDRIVE_KIRO_SKILLS_PATH` |
| Warp | `SKILLDRIVE_WARP_SKILLS_PATH` |
| Trae | `SKILLDRIVE_TRAE_SKILLS_PATH` |
| Factory | `SKILLDRIVE_FACTORY_SKILLS_PATH` |
| Kimi | `SKILLDRIVE_KIMI_SKILLS_PATH` |
| Mistral | `SKILLDRIVE_MISTRAL_SKILLS_PATH` |
| Pi | `SKILLDRIVE_PI_SKILLS_PATH` |
| Antigravity | `SKILLDRIVE_ANTIGRAVITY_SKILLS_PATH` |
| OpenClaw | `SKILLDRIVE_OPENCLAW_SKILLS_PATH` |
