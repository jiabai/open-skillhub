...
- [ ] macOS release packaging documentation and runbook (2026-05-03) ✅ Windows docs phase requires `python scripts/validate_agents_docs.py --level ERROR` and `git diff --check`; future release phase requires macOS `npm run dist:mac`, notarization, stapling, Gatekeeper, and smoke validation. See `docs/exec-plans/active/2026-05-03-macos-release-packaging.md`
