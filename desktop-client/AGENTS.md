...
- Read `tasks.md` and the active ExecPlan before changing code.
...
- Update `tasks.md`, `docs/ARCHITECTURE.md`, and any touched design, security, or reference docs when behavior changes.
