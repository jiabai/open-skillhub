...
from backend.api.v1.runtime_config import router as runtime_config_router
...
api_router.include_router(runtime_config_router, prefix="/runtime-config", tags=["runtime-config"])
