...
SkillDrive 目前没有真正面向未登录用户的公开宣传导览页。

SkillDrive 需要一个可信、产品相关、可国际化的公开 Landing Page，用于说明它是面向
...
1. 未登录访客访问 SkillDrive 根路径时，可以理解产品用途，并选择注册、登录或浏览公开 Skills。
2. 已有用户从公开页面进入登录流程，再回到认证后 Console。
3. 团队成员或部署方需要在不登录的情况下向同事展示 SkillDrive 的核心价值。
